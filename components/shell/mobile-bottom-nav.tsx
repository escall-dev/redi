...
export function MobileBottomNav() {
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 left-0 right-0 z-50 block border-t border-border/70 bg-card/95 pb-[max(0.5rem,env(safe-area-inset-bottom))] pt-0 shadow-[0_-4px_16px_rgba(76,45,115,0.05)] backdrop-blur-md sm:hidden overflow-visible"
    >
      <div className="grid grid-cols-5 items-center justify-items-center px-1 w-full max-w-md mx-auto">
        ...
        <div className="relative flex flex-col items-center justify-end w-full">
          ...
          >
            ...
            <div className="flex size-[72px] items-center justify-center rounded-full bg-card/95 backdrop-blur-md border border-border/70 shadow-[0_-2px_12px_rgba(76,45,115,0.06)]">
              {/* 52px Inner Action Button */}
              <div className="flex size-[52px] items-center justify-center rounded-full bg-primary text-primary-foreground shadow-[0_6px_18px_rgba(76,45,115,0.28)] group-hover:scale-105 group-hover:shadow-[0_8px_24px_rgba(76,45,115,0.36)] transition-all">
